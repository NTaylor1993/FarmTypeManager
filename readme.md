...
IsOn | No | true, false | Whether this item should be "on" or "off", e.g. whether a fireplace should be lit. | This setting mainly applies to big craftables and furniture that act as light sources. It does NOT currently affect the "object" category, e.g. torches.
